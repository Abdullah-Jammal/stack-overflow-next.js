      ...
      >
          ...
          render={({ field }) => (
            <FormItem className="flex w-full flex-col gap-1">
              ...
              <FormDescription className="body-regular text-light-500">
                Be specific and imagin that you are asking another person.
              </FormDescription>
              ...
              {field.value.length > 0 && (
                <div className="flex-start mt-2.5 gap-2.5">
                  {field.value.map((tag: any) => (
                    <Badge
                      key={tag}
                      className="text-dark300_light700 background-light700_dark400 flex gap-2 py-1"
                    >
                      {tag}
                      <Image
        ...
        >
          {isSubmitting ? (
            ...
            <>{type === "create" ? "Create Question" : "Ask a question"}</>
          )}
        </Button>
      </form>
    </Form>
